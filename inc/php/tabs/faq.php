                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-<?php echo $i; $i++ ?>">
                            ...
                            <?php _e( 'Enjoy your fancy Post/Page Editor.', $plugin['text'] ); ?>
                            <?php _e( 'It\'s that simple!', $plugin['text'] ); ?>
                        </div>

                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'Does this plugin provide a syntax highlighting for the Theme/Plugin Editor?', $plugin['text'] ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php
                                printf(
                                    __( 'No, only the Post/Page Editor supports. For the Theme/Plugin Editor you can use my another plugin that called the %s.', $plugin['text'] ),
