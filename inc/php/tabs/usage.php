        ...
        <div id="post-body-content" class="has-sidebar-content">
            <div class="meta-box-sortabless">
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <p><?php _e( 'To replace the default Post/Page HTML editor with an enhanced editor that provided by this plugin, simply follow these steps:', $plugin['text'] ); ?></p>
                        <ol class="custom-counter">
                            ...
                            <li><?php _e( 'Enjoy your fancy Post/Page Editor.', $plugin['text'] ); ?> <?php _e( 'It\'s that simple!', $plugin['text'] ); ?></li>
                        </ol>
                        <p class="note">
                            <?php
                                printf(
