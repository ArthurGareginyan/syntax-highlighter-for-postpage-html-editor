        ...
        <div id="poststuff" class="metabox-holder has-right-sidebar">
            ...
            <div class="tab-page fade" id="tab-usage">
                <div class="postbox">
                    ...
                    <div class="inside">
                        <p><?php _e( 'To replace the default Post/Page HTML editor with an enhanced editor that provided by this plugin, simply follow these steps:', $text ); ?></p>
                        <ol class="custom-counter">
                            <li><?php _e( 'Go to the "Settings" tab.', $text ); ?></li>
                            <li><?php _e( 'Select the desired settings.', $text ); ?></li>
                            <li><?php _e( 'Click the "Save changes" button.', $text ); ?></li>
                            <li><?php _e( 'Enjoy your fancy Post/Page Editor.', $text ); ?> <?php _e( 'It\'s that simple!', $text ); ?></li>
                        </ol>
            ...
            <div class="tab-page fade" id="tab-faq">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-3"><?php _e( 'On the "Settings" tab, select the desired settings and click the "Save changes" button. Enjoy your fancy Post/Page Editor. It\'s that simple!', $text ); ?></div>

                        <div class="question-4"><?php _e( 'Does this plugin provide a syntax highlighting for the Theme/Plugin Editor?', $text ); ?></div>
                        <div class="answer-4"><?php printf(
                                                            __( 'No, only the Post/Page Editor supports. For the Theme/Plugin Editor you can use my another plugin that called the %s.', $text ),
                                                                '<a href="https://wordpress.org/plugins/syntax-highlighter-for-wp-editor" target="_blank">Syntax Highlighter for Theme/Plugin Editor</a>'
                                                          );
                                              ?></div>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <span class="image-with-button pull-left">
                            <img src="<?php echo SPACEXCHIMP_P014_URL . 'inc/img/thanks.png'; ?>" alt="Thanks!">
