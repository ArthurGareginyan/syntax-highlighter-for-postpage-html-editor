            ...
            <div class="tab-page fade" id="tab-faq">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="question-8 question-red"><?php _e( 'Where to report bug if found?', SHPPHE_TEXT ); ?></div>
                        ...
                        <div class="question-9"><?php _e( 'Where to share any ideas or suggestions to make the plugin better?', SHPPHE_TEXT ); ?></div>
                        ...
                        <div class="question-10"><?php _e( 'I love this plugin! Can I help somehow?', SHPPHE_TEXT ); ?></div>
