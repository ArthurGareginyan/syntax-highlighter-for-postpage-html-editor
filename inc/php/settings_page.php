...
<div class="example">
	...
	<div class="wrap">
		<h2>
            <?php _e( 'Syntax Highlighter for Post/Page HTML Editor', SHPPHE_TEXT ); ?>
            <br/>
            <span>
                <?php _e( 'by <a href="http://www.arthurgareginyan.com" target="_blank">Arthur Gareginyan</a>', SHPPHE_TEXT ); ?>
            <span/>
		</h2>
            ...
            <div class="inner-sidebar">
                <div id="side-sortables" class="meta-box-sortabless ui-sortable">
                    ...
                    <div id="about" class="postbox">
                        <h3 class="title"><?php _e( 'About', SHPPHE_TEXT ); ?></a></h3>
                        <div class="inside">
                    ...
                    <div id="using" class="postbox">
                        <h3 class="title"><?php _e( 'Using', SHPPHE_TEXT ); ?></a></h3>
                        <div class="inside">
                            <p><?php _e( 'To use, select the desired settings, then click "Save Changes". It\'s that simple!', SHPPHE_TEXT ); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="meta-box-sortabless">
                        ...
                        <form name="SHighlighterForWPE-form" action="options.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="postbox" id="Settings">
                                ...
                                <div class="inside">
                                    <p><?php _e( 'There you can configure this plugin.', SHPPHE_TEXT ); ?></p>
                            ...
                            <div class="postbox" id="Preview">
                                ...
                                <div class="inside">
                                    <p><?php _e( 'Click "Save Changes" to update this preview.', SHPPHE_TEXT ); ?></p>
