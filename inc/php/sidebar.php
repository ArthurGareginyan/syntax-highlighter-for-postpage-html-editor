    ...
    <div class="inner-sidebar">
        <div id="side-sortables" class="meta-box-sortabless ui-sortable">
            ...
            <div class="postbox about">
                ...
                <div class="inside">
                    <p><?php _e( 'This plugin replaces the defaults WordPress Post/Page HTML Editor with an enhanced editor with syntax highlighting, line numbering, etc.', $plugin['text'] ); ?></p>
                </div>
            </div>
            <!-- END ABOUT -->
