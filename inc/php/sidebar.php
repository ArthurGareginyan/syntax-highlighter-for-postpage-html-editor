    ...
    <div class="inner-sidebar">
        <div id="side-sortables" class="meta-box-sortabless ui-sortable">
            ...
            <div class="postbox banner">
                ...
                <div class="inside">
                    <a href="https://www.spacexchimp.com/" target="_blank">
                        <img src="<?php echo SPACEXCHIMP_P014_URL . 'inc/img/spacexchimp-logo.png'; ?>" alt="Space X-Chimp">
                    </a>
                </div>
            </div>
            ...
            <div class="postbox about">
                ...
                <div class="inside">
                    <p><?php _e( 'This plugin replaces the defaults WordPress Post/Page HTML Editor with an enhanced editor with syntax highlighting, line numbering, etc.', $text ); ?></p>
                </div>
            </div>
