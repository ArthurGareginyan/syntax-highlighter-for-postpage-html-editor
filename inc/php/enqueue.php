 ...
 */
function spacexchimp_p014_load_scripts_codemirror( $options, $prefix, $url, $version ) {
 ...
 */
function spacexchimp_p014_load_scripts_dynamic_js( $options, $prefix ) {
...
function spacexchimp_p014_load_scripts_admin( $hook ) {
    ...
    if ( 'post.php' == $hook )  {
        ...
        spacexchimp_p014_load_scripts_codemirror( $options, $prefix, $url, $version );

        // Call the function that contains the dynamic JavaScript
        spacexchimp_p014_load_scripts_dynamic_js( $options, $prefix );
    }
