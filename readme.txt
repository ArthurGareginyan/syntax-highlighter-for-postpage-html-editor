...
Replaces the defaults WordPress Post/Page HTML Editor with an enhanced editor with syntax highlighting and line numbering.
...
If you would like to add a translation to this plugin then please head to our [Translating WordPress](https://translate.wordpress.org/projects/wp-plugins/syntax-highlighter-for-postpage-html-editor) page.
...
After installation, a "`Syntax Highlighter for Post/Page HTML Editor`" menu item will appear in the "`Settings`" section. Click on this in order to view plugin's administration page.
...
You can find the plugin settings page at "`WP Admin Panel`" -> "`Settings`" -> "`Syntax Highlighter for Post/Page HTML Editor`".
...
A. Please visit the [Dedicated Plugin Page on GitHub](https://github.com/ArthurGareginyan/syntax-highlighter-for-postpage-html-editor) and report.
...
"Syntax Highlighter for Post/Page HTML Editor" is one of the personal software projects of [Arthur Gareginyan](http://www.arthurgareginyan.com).
