...
After installation and activation, the "`Syntax Highlighter for Post/Page HTML Editor`" menu item will appear in the "`Settings`" section of Admin Panel. Click on it in order to view the plugin settings page.
...
"Syntax Highlighter for Post/Page HTML Editor" is one of the personal software projects of [Arthur Gareginyan](https://www.arthurgareginyan.com).
