 ...
 *
 * Copyright 2017 Space X-Chimp Studio ( website : https://www.spacexchimp.com )
 *
 ...
 */
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/core.php' );
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/upgrade.php' );
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/versioning.php' );
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/enqueue.php' );
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/functional.php' );
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/controls.php' );
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/page.php' );
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/messages.php' );
require_once( SPACEXCHIMP_P014_PATH . 'inc/php/uninstall.php' );
